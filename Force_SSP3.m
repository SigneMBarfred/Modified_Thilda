%forcing file for the high emission ssp2 (GCAM for CMIP7)
%created july 2026

function [daint,MHC,MHA,MHM,LWR,co2emfos,co2emland,ch4em,co2seq1,co2seq2]=Force_SSP3(h)
...
co2emfos   = interp1(CO2fosem_SSP3,1:h:751);
co2emland  = interp1(CO2landem_SSP3,1:h:751);
ch4em      = interp1(CH4em_SSP3,1:h:751);


co2seq1 = zeros(size(co2emfos));
co2seq2 = zeros(size(co2emfos));

LWR = [218.91 1.37]; %copied from A2 5C scenario (is it a reasonable value?)
