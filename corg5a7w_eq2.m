function [s,x,Rm,C1,D5,D4,D3,D2,D1,C2,C3,C4,C5,Res5]=...
    corg5a_eq2(w,Db,jo2,beta,FC,fi,F,del,IniO2,zb,zo)
  ...
  c37=-exp(s(19)*zo);
  c38=-exp(s(20)*zo);
  c39=(w(5)-Db*s(9))*exp(s(9)*zo);
  c40=(w(5)-Db*s(10))*exp(s(10)*zo);
  c41=-(w(5)-Db*s(19))*exp(s(19)*zo);
  c42=-(w(5)-Db*s(20))*exp(s(20)*zo);
  c43=exp(s(19)*zb(6));
  c44=exp(s(20)*zb(6));
  c45=-exp(s(21)*zb(6));
  c46=-exp(s(22)*zb(6));
 ...
 Rm5=(1-fi(5))*jo2*(x(9)*(exp(s(9)*zo)-exp(s(9)*zb(5)))/s(9)+...
                    x(10)*(exp(s(10)*zo)-exp(s(10)*zb(5)))/s(10)+...
              beta*(x(11)*(exp(s(19)*zb(6))-exp(s(19)*zo))/s(19)+...
                    x(12)*(exp(s(20)*zb(6))-exp(s(20)*zo))/s(20)));
 ...
 Rm = [Rm1 Rm2 Rm3 Rm4 Rm5 Rm6 Rm7];
  ...
  D5 = -del(5)*((x(9)/s(9)*exp(s(9)*zo)+x(10)/s(10)*exp(s(10)*zo)...
   +beta*(x(11)*(exp(s(19)*zb(6))-exp(s(19)*zo))/s(19)+x(12)*(exp(s(20)*zb(6))-exp(s(20)*zo))/s(20)...
    +del(6)/del(5)*(x(13)*(exp(s(21)*zb(7))-exp(s(21)*zb(6)))/s(21)+x(14)*(exp(s(22)*zb(7))-exp(s(22)*zb(6)))/s(22))...
    +del(7)/del(5)*(x(15)*(exp(s(23)*zb(8))-exp(s(23)*zb(7)))/s(23)+x(16)*(exp(s(24)*zb(8))-exp(s(24)*zb(7)))/s(24)))));
  ...
  Res5 = -(C5 + D5*zo + del(5)*(x(9)*exp(s(9)*zo)/(s(9)^2)+x(10)*exp(s(10)*zo)/(s(10)^2)));
