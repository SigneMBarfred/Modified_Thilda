function [daint,MHC,MHA,MHM,LWR,co2emfos,co2emland,ch4em,co2seq1,co2seq2]=ForceGS1O_3C(h)
...
fgeo=1e-3;           %fractional escape factor for geological stored CO2,
                       % 1e-4 means 1% escape over 100 years
fact=1;              %fact = 1 for leakage to the ocean of CO2 sequestered
