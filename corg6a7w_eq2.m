function [s,x,Rm,C1,D6,D5,D4,D3,D2,D1,C2,C3,C4,C5,C6,Res6]=...
  ...
  c45=-exp(s(21)*zo);
  c46=-exp(s(22)*zo);
  c47=-(w(6)-Db*s(25))*exp(s(25)*zo);
  c48=-(w(6)-Db*s(26))*exp(s(26)*zo);
  c49=(w(6)-Db*s(21))*exp(s(21)*zo);
  c50=(w(6)-Db*s(22))*exp(s(22)*zo);
  c51=exp(s(21)*zb(7));
  c52=exp(s(22)*zb(7));
  c53=-exp(s(23)*zb(7));
  c54=-exp(s(24)*zb(7));
 ...
 Rm6=(1-fi(6))*jo2*(x(11)*(exp(s(25)*zo)-exp(s(25)*zb(6)))/s(25)+...
                     x(12)*(exp(s(26)*zo)-exp(s(26)*zb(6)))/s(26)+...
               beta*(x(13)*(exp(s(21)*zb(7))-exp(s(21)*zo))/s(21)+...
                     x(14)*(exp(s(22)*zb(7))-exp(s(22)*zo))/s(22)));
 Rm7=(1-fi(7))*beta*jo2*(x(15)*(exp(s(23)*zb(8))-exp(s(23)*zb(7)))/s(23)+...
  ...
  D6 = -del(6)*((x(11)/s(25)*exp(s(25)*zo)+x(12)/s(26)*exp(s(26)*zo)...
   +beta*(x(13)*(exp(s(21)*zb(7))-exp(s(21)*zo))/s(21)+x(14)*(exp(s(22)*zb(7))-exp(s(22)*zo))/s(22)...
    +del(7)/del(6)*(x(15)*(exp(s(23)*zb(8))-exp(s(23)*zb(7)))/s(23)+x(16)*(exp(s(24)*zb(8))-exp(s(24)*zb(7)))/s(24)))));
  ...
  Res6 = -(C6 + D6*zo + del(6)*(x(11)*exp(s(25)*zo)/(s(25)^2)+x(12)*exp(s(26)*zo)/(s(26)^2)));
