function [s,x,Rm,C1,D2,D1,C2,Res2]=corg2a5w_eq2(w,Db,jo2,beta,FC,fi,F,del,IniO2,zb,zo)
  ...
  c13=-exp(s(13)*zo);
  c14=-exp(s(14)*zo);
  c15=-(w(2)-Db*s(3))*exp(s(3)*zo);
  c16=-(w(2)-Db*s(4))*exp(s(4)*zo);
  c17=(w(2)-Db*s(13))*exp(s(13)*zo);
  c18=(w(2)-Db*s(14))*exp(s(14)*zo);
  c19=exp(s(13)*zb(3));
  c20=exp(s(14)*zb(3));
  c21=-exp(s(15)*zb(3));
  c22=-exp(s(16)*zb(3));
 ...
 Rm2=(1-fi(2))*jo2*(x(3)*(exp(s(3)*zo)-exp(s(3)*zb(2)))/s(3)+...
                    x(4)*(exp(s(4)*zo)-exp(s(4)*zb(2)))/s(4)+...
              beta*(x(5)*(exp(s(13)*zb(3))-exp(s(11)*zo))/s(13)+...
                    x(6)*(exp(s(14)*zb(3))-exp(s(14)*zo))/s(14)));  
 ...
 Rm7=(1-fi(7))*beta*jo2*(x(15)*(exp(s(23)*zb(8))-exp(s(23)*zb(7)))/s(23)+...
  ...
  D2 = -del(2)*((x(3)/s(3)*exp(s(3)*zo)+x(4)/s(4)*exp(s(4)*zo)...
   +beta*(x(5)*(exp(s(13)*zb(3))-exp(s(13)*zo))/s(13)+x(6)*(exp(s(14)*zb(3))-exp(s(14)*zo))/s(14)...
    +del(3)/del(2)*(x(7)*(exp(s(15)*zb(4))-exp(s(15)*zb(3)))/s(15)+x(8)*(exp(s(16)*zb(4))-exp(s(16)*zb(3)))/s(16))...
    +del(4)/del(2)*(x(9)*(exp(s(17)*zb(5))-exp(s(17)*zb(4)))/s(17)+x(10)*(exp(s(18)*zb(5))-exp(s(18)*zb(4)))/s(18))...
    +del(5)/del(2)*(x(11)*(exp(s(19)*zb(6))-exp(s(19)*zb(5)))/s(19)+x(12)*(exp(s(20)*zb(6))-exp(s(20)*zb(5)))/s(20))...
    +del(6)/del(2)*(x(13)*(exp(s(21)*zb(7))-exp(s(21)*zb(6)))/s(21)+x(14)*(exp(s(22)*zb(7))-exp(s(22)*zb(6)))/s(22))...
    +del(7)/del(2)*(x(15)*(exp(s(23)*zb(8))-exp(s(23)*zb(7)))/s(23)+x(16)*(exp(s(24)*zb(8))-exp(s(24)*zb(7)))/s(24)))));
 ...
 C2 = C1 - (D2-D1)*zb(2)-...
  ...
  Res2 = -(C2 + D2*zo + del(2)*(x(3)*exp(s(3)*zo)/(s(3)^2)+x(4)*exp(s(4)*zo)/(s(4)^2)));
