% %adjusted to not carry drho, so use for scaled experiemtne
% function Thilda_R
% %clear global
...
% 
%     t=t+dt;
%     [k1LL,k1HL,k1AT,k1LB,k1GS,srLL1,srHL1] = ...
...
%       nLB = LB+k1LB*dt/2;
%       nGS = GS+k1GS*dt/2;
%     [k2LL,k2HL,k2AT,k2LB,k2GS,srLL2,srHL2] =...
...
%       nLB = LB+k2LB*dt/2;
%       nGS = GS+k2GS*dt/2;
%     [k3LL,k3HL,k3AT,k3LB,k3GS,srLL3,srHL3] =...
%         ODE_R(t+dt/2,nLL,nHL,MHC,MHA,MHM,LWR,nAT,nLB,nGS,GAw,GAc,pCalLL,pCalHL,pOrgLL,pOrgHL,daint,co2emfos,co2emland,ch4em,co2seq1,co2seq2,k);
%       nLL = LL+k3LL*dt; 
%       nHL = HL+k3HL*dt; 
%       nAT = AT+k3AT*dt; 
%       nLB = LB+k3LB*dt; 
%       nGS = GS+k3GS*dt/2;
%     [k4LL,k4HL,k4AT,k4LB,k4GS,srLL4,srHL4] =...
...
% %------------------------------
% 
% save OutThilda_R st sqmax sLL sHL sAT sLB sGS srLL srHL dwcLL dwcHL dworgCLL dworgCHL...
